...
describe('useitem', () => {
  ...
  it('importing a function', () => {
    expect(parser.parseEval('use function My\\Full\\functionName;')).toMatchSnapshot();
  });
  it('importing a function with type', () => {
    expect(parser.parseEval('use function My\\Full\\functionName as func;')).toMatchSnapshot();
  });
  it('importing a class', () => {
    expect(parser.parseEval('use some\\my_namespace\\ClassC;')).toMatchSnapshot();
  });
  it('importing a class with type', () => {
    expect(parser.parseEval('use some\\my_namespace\\ClassC as C;')).toMatchSnapshot();
  });
  ...
  it('importing a constant with type', () => {
    expect(parser.parseEval('use const My\\Full\\CONSTANT as MY_CONST;')).toMatchSnapshot();
  });
});
