...
describe("php-src tests", function () {
  // Zend/tests/type_declarations/mixed/validation/mixed_property_weak_success.phpt
  it("Test that the mixed property type accepts any kind of value in weak mode", function () {
